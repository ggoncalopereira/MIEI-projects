...
public class Input {
 ...
 public static String lerString(String in) {
 ...
 public static int lerInt(String in) {
     Scanner input = new Scanner(in);
     boolean ok = false; 
     int i = 0; 
     while(!ok) {
  ...
  public static double lerDouble(String in) {
     Scanner input = new Scanner(in);
     boolean ok = false; 
     double d = 0.0; 
     while(!ok) {
   ...
   public static float lerFloat(String in) {
     Scanner input = new Scanner(in);
     boolean ok = false; 
     float f = 0.0f; 
     while(!ok) {
   ...
   public static boolean lerBoolean(String in) {
     Scanner input = new Scanner(in);
     boolean ok = false; 
     boolean b = false; 
     while(!ok) {
  ...
  public static short lerShort(String in) {
     Scanner input = new Scanner(in);
     boolean ok = false; 
     short s = 0; 
     while(!ok) {
