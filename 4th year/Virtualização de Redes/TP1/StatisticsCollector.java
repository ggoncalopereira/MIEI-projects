				...
				for (OFStatsReply r : e.getValue()) {
					...
					for (OFPortStatsEntry pse : psr.getEntries()) {
						...
						if (portStats.containsKey(npt) || tentativePortStats.containsKey(npt)) {
							...
							System.out.println("DPID:" + e.getKey() + " port: " + pse.getPortNo());
							System.out.println("Speed: " + speed);
							System.out.println("Received bits: " + (rxBytesCounted.getValue() * BITS_PER_BYTE) / timeDifSec);
							System.out.println("Transfered bits: " + (txBytesCounted.getValue() * BITS_PER_BYTE) / timeDifSec);
